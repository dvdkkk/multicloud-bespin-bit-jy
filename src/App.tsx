        ...
        <FadeIn className="max-w-7xl mx-auto relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-blue-800/50 rounded-2xl flex items-center justify-center shrink-0 border border-blue-700">
                    <HelpCircle className="text-blue-300" size={24} />
                  </div>
                  <div>
                    <div className="text-blue-300 font-bold text-sm mb-1">교육문의</div>
                    <div className="text-3xl font-black tracking-tight">1533-6176</div>
                  </div>
                </div>
            ...
            <div className="bg-white p-6 md:p-8 rounded-3xl shadow-2xl">
              ...
              <form action="https://formspree.io/f/xeelngla" method="POST" className="space-y-3 md:space-y-4">
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex flex-col md:flex-row items-center gap-4 md:gap-8">
            ...
            <div className="flex items-center gap-2 text-slate-300 bg-slate-900 px-4 py-2 rounded-full border border-slate-800">
              ...
              <span className="font-medium">교육문의</span>
              <a href="tel:1533-6176" className="font-bold text-white hover:text-blue-400 transition-colors">1533-6176</a>
            </div>
          </div>
